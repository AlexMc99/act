...
class AuthController {
    ...
    async login (username, password) {
        ...
        // for the case of undefined from passwordHash, we catch the error
        // by sending status of 500 in the route /login from index.js
        const passwordHashConstant = passwordHash.passwordHash;
        const isVerified = await this.verifyPassword(passwordHashConstant, password);
